...
test_add_execute_raises_error = create_execute_raises_error_test(add, EXAMPLE_PROJECT, 1, 1)

test_add_fetchone_raises_error = create_fetchone_raises_error_test(add, EXAMPLE_PROJECT, 1, 1)
