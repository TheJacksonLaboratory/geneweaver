...
@pytest.mark.parametrize("model_class", [BaseModel, GenesetScoreType, BatchUploadGeneset])
...
@pytest.mark.parametrize("model_class", [str, int, float, bool, list, tuple, dict, 1, ""])
