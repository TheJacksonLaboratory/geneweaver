/* Driver file for Clique Enumerator
 *
...
extern int PRINT;
extern int node_num;
extern double time_check, time_expand, time_out;
...
void print_options(void)
{
  ...
  fprintf(stderr, "  -c <value>         number of entries in cache if choose algorithm v1\n");
...
int main(int argc, char  **argv)
{
  ...
  if (DEGREE) bigraph_degreelist_out(stdout, G);
