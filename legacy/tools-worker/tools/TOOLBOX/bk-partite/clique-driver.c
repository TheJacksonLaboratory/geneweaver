...
void print_options(void)
{
  ...
  fprintf(stderr, "  -inter         remove inter-partite edges without a neighbor in all other partite sets\n");
  fprintf(stderr, "  -intra         remove intra-partite edges without a neighbor in all other partite sets\n");
  fprintf(stderr, "\n");
}
...
int main(int argc, char  **argv)
{
  ...
  if (REMOVEINTER)
    remove_interpartite_edges(G);   //preprocess edges between partite sets

//  printf("done with graph setup\n");
...
//   else maximal_clique(G);
  ...
  printf("vertex maximum k-clique:\n");
  print_clique_vmax(stdout, G);
  printf("\n");

  printf("edge maximum k-clique:\n");
  print_clique_emax(stdout, G);
  printf("\n");
